...
class HexapodFlatEnvCfg(HexapodRoughEnvCfg):
    def __post_init__(self):
        ...
        self.events.add_base_mass.params["mass_distribution_params"] = (-0.0001, 0.0001) #just added this to see if (-5.0, 5.0) is the problem
        ...
        self.rewards.track_ang_vel_z_exp.weight = 0.5 #trying to keep it a little more straight
        self.rewards.track_ang_vel_z_exp.params["std"] = math.sqrt(0.25)*0.2

        # Penalties
        self.rewards.dof_torques_l2.weight = -1.0e-8 #was -2.5e-5

        self.rewards.feet_air_time.weight = 0.4 #was 0.22
        self.rewards.feet_air_time.params["threshold"] = 0.2  #rewarding a duty cycle of 2/3 -- trying to also get use of six legs
        
        self.rewards.dof_pos_limits.weight = -1.0
        self.rewards.dof_acc_l2.weight= -5.0e-9 #new
        self.rewards.ang_vel_xy_l2.weight = -0.00001
        self.rewards.undesired_contacts.weight = -1.0
        self.rewards.lin_vel_z_l2.weight = -0.001
        self.rewards.action_rate_l2.weight = -0.0000001 # tune this
        ...
        self.observations.policy.actions.history_length = 5 # was 5 @ 12_12_25 10-20-22
        ...
        #rl_cfg.RslRlBaseRunnerCfg.logger = "wandb"
        #self.RslRlBaseRunnerCfg.wandb_project = "hexapod"
